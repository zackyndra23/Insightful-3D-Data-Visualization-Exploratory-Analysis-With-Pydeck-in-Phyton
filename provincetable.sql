-- Creating indo_coordinate Database
CREATE DATABASE indo_coordinate;
-- Using indo_coordinate Database
USE indo_coordinate;
...
-- Showing Provinces Table
SELECT *
FROM provinces;

-- Menunjukkan direktori tempat MySQL diperbolehkan menulis
SELECT @@secure_file_priv;

-- Exporting the table into .csv file
SELECT 'id', 'name', 'alt_name', 'latitude', 'longitude'
UNION
SELECT id, name, alt_name, latitude, longitude
INTO OUTFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\province.csv'
